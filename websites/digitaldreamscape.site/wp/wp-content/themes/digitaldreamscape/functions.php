...
{
    // Enqueue theme stylesheet with cache busting - updated version for menu horizontal fix
    wp_enqueue_style('digitaldreamscape-style', get_stylesheet_uri(), array(), '2.2.0');
